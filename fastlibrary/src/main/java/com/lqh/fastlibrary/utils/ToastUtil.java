...
import com.lqh.fastlibrary.view.core.radius.delegate.RadiusTextViewDelegate;
...
//                    .setBackgroundColor(ColorUtils.getColor(R.color.white75))
        ...
        /**
         * 设置文本颜色{@link RadiusTextViewDelegate#setTextColor(int)}
         *
         * @param textColor
         * @return
         */
