package com.lqh.fastlibrary.view.sweetalertdialog;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public void setLoadingIndicator(@NotNull String indicator) {
        if (ObjectUtils.isNotEmpty(mLoadingIndicatorView)) {
            LogUtils.json("设置动画样式");
            mLoadingIndicatorView.setIndicator(indicator);
        } else {
            LogUtils.json("为空");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_sweet_alert_dialog_customer);
        ...
        mLoadingIndicatorView = findViewById(R.id.loading_indicatorView);
...
//                    mButtonsContainer.setVisibility(View.GONE);
     ...
     * @param isAutoDisMiss
     */
    public void autoDismissWithAnimation(boolean isAutoDisMiss) {
        com.blankj.utilcode.util.ViewUtils.runOnUiThreadDelayed(() -> dismissWithAnimation(isAutoDisMiss), 2000);
    }
     ...
     * @param delay 延时时间(毫秒)
     */
    public void autoDismissWithAnimation(int delay) {
        com.blankj.utilcode.util.ViewUtils.runOnUiThreadDelayed(() -> dismissWithAnimation(true), delay);
    }
