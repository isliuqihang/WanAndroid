...
import com.lqh.fastlibrary.BuildConfig;
import com.lqh.fastlibrary.view.core.DragLayout;
...
public class BaseDialog<T extends BaseDialog> extends Dialog {
     ...
     * @param <T>
     */
    protected static class BasisBuilder<T extends BaseDialog.BasisBuilder> {
        ...
        protected boolean mDragEnable = false;
        protected BaseDialog.OnTextViewLineListener mOnTextViewLineListener;
         ...
         * @return
         */
        public T setOnTextViewLineListener(BaseDialog.OnTextViewLineListener listener) {
        ...
        /**
         * 设置dialog 键盘事件监听
         * {@link #setOnKeyListener(DialogInterface.OnKeyListener)}
         *
         * @param listener
         * @return
         */
