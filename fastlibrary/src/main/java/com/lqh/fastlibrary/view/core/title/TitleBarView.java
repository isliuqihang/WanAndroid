package com.lqh.fastlibrary.view.core.title;
...
import com.lqh.fastlibrary.view.core.alpha.AlphaImageView;
import com.lqh.fastlibrary.view.core.alpha.AlphaTextView;
import com.lqh.fastlibrary.view.core.title.util.ViewGroupUtils;
import com.lqh.fastlibrary.view.core.util.DrawableUtil;
import com.lqh.fastlibrary.view.core.util.NotchUtil;
import com.lqh.fastlibrary.view.core.util.ResourceUtil;
import com.lqh.fastlibrary.view.core.util.StatusBarUtil;

/**
 * <pre>
 *     description:定制标题栏-支持沉浸式
 *     date:2021/7/29 0029
 *     update:2021/7/29 0029  15:44
 *     version:1.0
 *     @author LQH
 * </pre>
 */
...
public class TitleBarView extends ViewGroup {
    ...
    public TitleBarView setTitleMainText(CharSequence charSequence) {
        ...
        if ((getParent() != null && "CollapsingTitleBarLayout".equals(getParent().getClass().getSimpleName()))) {
            return this;
        }
