package com.lqh.fastlibrary.view.core.progress;
...
import com.lqh.fastlibrary.view.loadingindicatorview.LoadingIndicatorView;
import com.lqh.fastlibrary.view.loadingindicatorview.indicators.LineScalePulseOutRapidIndicator;
...
public class WaitDialog extends BaseDialog<WaitDialog> {
     ...
     * Material 风格
     */
    public static class MaterialBuilder extends WaitDialog.Builder<WaitDialog.MaterialBuilder> {
         ...
         * @return
         */
        public WaitDialog.MaterialBuilder setDuration(int duration) {
            mDuration = duration;
            return this;
        }
         ...
         * @return
         */
        public WaitDialog.MaterialBuilder setRoundEnable(boolean enable) {
         ...
         * @return
         */
        public WaitDialog.MaterialBuilder setBorderWidth(float w) {
            this.mBorderWidth = w;
            return this;
        }
     ...
     * Material 风格
     */
    public static class CustomerBuilder extends WaitDialog.Builder<WaitDialog.CustomerBuilder> {


        public CustomerBuilder(Context context) {
            super(context);
        }
        ...
        public View createProgressView() {
            ...
            LoadingIndicatorView loadingIndicatorView = new LoadingIndicatorView(mContext);

            loadingIndicatorView.setIndicator(new LineScalePulseOutRapidIndicator());
            loadingIndicatorView.setIndicatorColor(ColorUtils.getColor(R.color.colorActionSheetCancelText));

//            mProgressBar = new MaterialProgressBar(mContext);
            loadingIndicatorView.setLayoutParams(new ViewGroup.LayoutParams(mLoadingSize, mLoadingSize));
//            mProgressBar.setDuration(mDuration)
//                    .setRoundEnable(mRoundEnable)
//                    .setBorderWidth(mBorderWidth)
//                    .setArcColor(mLoadingColor);
     ...
     * 微博风格
     */
    public static class WeBoBuilder extends WaitDialog.ProgressBarBuilder<WaitDialog.WeBoBuilder> {
     ...
     * 类微信模式
     */
    public static class WeChatBuilder extends WaitDialog.ProgressBarBuilder<WaitDialog.WeChatBuilder> {
     ...
     * 标准模式
     */
    public static class NormalBuilder extends WaitDialog.ProgressBarBuilder<WaitDialog.NormalBuilder> {
     ...
     * @param <T>
     */
    private static class ProgressBarBuilder<T extends WaitDialog.ProgressBarBuilder> extends WaitDialog.Builder<T> {
     ...
     * @param <T>
     */
    private static abstract class Builder<T extends WaitDialog.Builder> extends BasisBuilder<T> implements WaitDialog.ICreateContentView {
